import {bookmark, bookmarkFolder, convertNumberIntoHeader, bookmarkLink, addDescription, addBookwormsDescription} from '../readme'
...
describe('Templates - Readme', () => {
    ...
    describe('bookmarkFolder', () => {
        test('should return description, header and children', () => {
            expect(bookmarkFolder(0, 'Section label', 'Section description', '_Children markdown_')).toMatchSnapshot()
        });
    })
    ...
    describe('addBookwormsDescription', () => {
        test('should return description for file comment', () => {
            expect(addBookwormsDescription(1633027394454)).toEqual('_These bookmarks were last updated on 30/09/2021, 19:43:14 using [Bookworms](https://github.com/thearegee/bookworms)_')
        });
    })
